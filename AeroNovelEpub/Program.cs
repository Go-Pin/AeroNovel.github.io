                    ...
                    if (File.Exists(contents))
                    {
                        ...
                        foreach (string f in files)
                        {
                            ...
                            if (File.Exists(filepath))
                            {
                                ...
                                {
                                    body = "<div class=\"info\" epub:type=\"acknowledgements\">" + body + "<p>AeroNovel EPUB生成器by AE " + DateTime.Now + "</p>"+
                                    //"<p>支持pop-up footnote</p><p>推荐使用阅读器:<br/>Apple Books<br/>Microsoft Edge (1809)<br/>Kindle(使用Kindlegen 转换)<br/>Lithium (Android)</p>"+
                                    "</div>";
